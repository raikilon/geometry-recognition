...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--pool_res', nargs='+', default=[1140, 780, 580], type=int,
                                 help='pooling res')
        ...
        self.parser.add_argument('--patience', type=int, default='10', help='patience for early stopping')
        self.parser.add_argument('--val_size', type=int, default='10', help='val dataset size')
        self.parser.add_argument('--elements', type=int, default='30', help='number of elements per class in training')
        # visualization params
        self.parser.add_argument('--export_folder', type=str, default='exp',
                                 help='exports intermediate collapses to this folder')
        # self.parser.add_argument('--export_file', type=str, default='T6.obj',
        #                         help='exports intermediate collapses to this folder')
        #
    ...
    def parse(self):
        ...
        # self.opt.name = "MeshCNN_ModelNet40_{}".format(datetime.now().strftime("%d_%b_%Y_%H_%M_%S"))
